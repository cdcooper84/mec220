...
Integremos la Ec. \eqref{eq:cilindro_p} de $0$ a $2\pi$:
%
\begin{align}
F &= \oint_A p dS = \int_0^{2\pi} p(\theta) \sqrt{\frac{K}{U_\infty}}d\theta \nonumber\\ 
&=\int_0^{2\pi}\left[\frac{U_\infty^2\rho}{2}\left(1+4\sin^2(\theta)\right) - p_\infty \right]\sqrt{\frac{K}{U_\infty}} d\theta = 0
\end{align}
