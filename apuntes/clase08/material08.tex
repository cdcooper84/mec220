...
Quizás la forma más fácil de encontrar una expresión para el espesor de capa límite $\delta$ es a través de un análisis de cantidad de movimiento de la placa, como la que hicimos para llegar a la Ec. \eqref{eq:D_momentum}.
