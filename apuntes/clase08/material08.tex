...
\section*{Solución de capa límite en flujo laminar}
...
%
\begin{equation}
\frac{\partial u}{\partial x} = U_\infty f''(\eta) \frac{\partial \eta}{\partial x} =-U_\infty f''(\eta) \frac{1}{2x} \eta
\end{equation}
